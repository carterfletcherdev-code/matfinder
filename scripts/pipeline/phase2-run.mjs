...
// ── Cities config ───────────────────────────────────────────────────
const CITIES = [
  // US — top markets not in Phase 1
  { id: 'dfw',     name: 'Dallas-Fort Worth', state: 'TX', country: 'US', lat: 32.7767, lng: -96.7970,  radiusMeters: 50000 },
  { id: 'phx',     name: 'Phoenix',           state: 'AZ', country: 'US', lat: 33.4484, lng: -112.0740, radiusMeters: 50000 },
  { id: 'dc',      name: 'Washington DC',     state: 'DC', country: 'US', lat: 38.9072, lng: -77.0369,  radiusMeters: 40000 },
  { id: 'bos',     name: 'Boston',            state: 'MA', country: 'US', lat: 42.3601, lng: -71.0589,  radiusMeters: 35000 },
  { id: 'sac',     name: 'Sacramento',        state: 'CA', country: 'US', lat: 38.5816, lng: -121.4944, radiusMeters: 35000 },
  { id: 'sea',     name: 'Seattle',           state: 'WA', country: 'US', lat: 47.6062, lng: -122.3321, radiusMeters: 40000 },
  { id: 'den',     name: 'Denver',            state: 'CO', country: 'US', lat: 39.7392, lng: -104.9903, radiusMeters: 35000 },
  { id: 'phl',     name: 'Philadelphia',      state: 'PA', country: 'US', lat: 39.9526, lng: -75.1652,  radiusMeters: 35000 },
  { id: 'pdx',     name: 'Portland',          state: 'OR', country: 'US', lat: 45.5152, lng: -122.6784, radiusMeters: 30000 },
  { id: 'nash',    name: 'Nashville',         state: 'TN', country: 'US', lat: 36.1627, lng: -86.7816,  radiusMeters: 30000 },
  // International tourist hubs
  { id: 'tokyo',   name: 'Tokyo',             state: '',   country: 'JP', lat: 35.6762, lng: 139.6503,  radiusMeters: 35000 },
  { id: 'bkk',     name: 'Bangkok',           state: '',   country: 'TH', lat: 13.7563, lng: 100.5018,  radiusMeters: 30000 },
  { id: 'sg',      name: 'Singapore',         state: '',   country: 'SG', lat: 1.3521,  lng: 103.8198,  radiusMeters: 25000 },
  { id: 'bcn',     name: 'Barcelona',         state: '',   country: 'ES', lat: 41.3851, lng: 2.1734,    radiusMeters: 25000 },
  { id: 'lis',     name: 'Lisbon',            state: '',   country: 'PT', lat: 38.7223, lng: -9.1393,   radiusMeters: 25000 },
  { id: 'mex',     name: 'Mexico City',       state: '',   country: 'MX', lat: 19.4326, lng: -99.1332,  radiusMeters: 35000 },
  { id: 'ams',     name: 'Amsterdam',         state: '',   country: 'NL', lat: 52.3676, lng: 4.9041,    radiusMeters: 25000 },
  { id: 'rome',    name: 'Rome',              state: '',   country: 'IT', lat: 41.9028, lng: 12.4964,   radiusMeters: 25000 },
  { id: 'bali',    name: 'Bali (Denpasar)',   state: '',   country: 'ID', lat: -8.6705, lng: 115.2126,  radiusMeters: 35000 },
  { id: 'phuket',  name: 'Phuket',            state: '',   country: 'TH', lat: 7.8804,  lng: 98.3923,   radiusMeters: 30000 },
];

// Multiple queries per city — Places API caps at ~60 results per query.
// Phase 2 broadens beyond BJJ to include all major grappling + striking disciplines.
const QUERIES = [
  // Grappling
  'jiu-jitsu',
  'BJJ academy',
...
// ── Output paths ─────────────────────────────────────────────────────
const OUT_DIR = 'scripts/pipeline/data/phase2';
